<template>
  <div>
    <svg-icon
      ...
      cr-pointer
      :primary="googleUrl ? true : undefined"
      @click="visible = true"
    ></svg-icon>
    <Modal v-model:visible="visible" :width="480">
      <div
        class="ma-20"
        flex="cen"
        style="font-size: 20px; line-height: 28px; font-weight: 500"
      >
        {{ t('绑定谷歌表') }}
      </div>
      <div class="ph-30 rel">
